...
public class Taex_errormensajestiendaDaoImpl extends JdbcDaoSupport implements Taex_errormensajestiendaDao {
    ...
    public List<Taex_errormensajestienda> obtenerFlujos(String flujos)  {
       ...
       // System.out.print(flujos);
        ...
        String sql = "SELECT "+ flujoid +", count(*)  " + counter +" FROM XTRACT.TAEX_ERRORMENSAJESTIENDA " +
        ...
        String sql2 = "SELECT B.FNFLUJOID, B.FCDESCFLUJO  as concat, count(*)"+ counter +
                "  FROM XTRACT.TAEX_ERRORMENSAJESTIENDA A LEFT JOIN XTRACT.TAEX_CATFLUJOS B ON A.FNFLUJOID = B.FNFLUJOID " +
    ...
    public List<Taex_errormensajestienda> obtenerSucursales(Integer fnflujoid)  {
        ...
        String sql = "SELECT  FNSUCURSALDEST"+", count(*)  " + counter +" FROM XTRACT.TAEX_ERRORMENSAJESTIENDA " +
    ...
    public List<Taex_errormensajestienda> obtenerCadenas(Integer fnflujoid, Integer fnsucursaldest)  {
        ...
        String sql = "SELECT FNPAISDEST, FNCANALDEST, FNSUCURSALDEST, "+
                ...
                "FCCADENAEJEC, FCDESCERROR FROM XTRACT.TAEX_ERRORMENSAJESTIENDA "+
    ...
    public List<Taex_errormensajestienda> obtenerCadena(Integer fnflujoid, String fnfolioconsec)  {
        ...
        String sql = "SELECT FNFLUJOID,FNPAISDEST,FNCANALDEST,FNSUCURSALDEST,FNFOLIOCONSEC,FDFECHAPROCESO,FNPAISORIG,FNCANALORIG," +
                ...
                " FROM XTRACT.TAEX_ERRORMENSAJESTIENDA "+
                "WHERE FNSTATUS>=0 AND "+
                "FNFLUJOID  ="+fnflujoid +
    ...
    public String eliminarCadena2(Number fnflujoid, Number fnpaisdest, Number fncanaldest, Number fnsucursaldest, String fcfolioconsec) {
        String mensaje = "";
    ...
    public String obtenerSucursal (Number fnflujoid, String fnfolioconsec)
    {
       ...
       // System.out.print("desdemetodo"+fnfolioconsec);
        ...
        String sql2 = "SELECT fnsucursaldest FROM XTRACT.TAEX_ERRORMENSAJESTIENDA WHERE FNFLUJOID = ? AND FNFOLIOCONSEC=? " +
