...
@Repository
@Transactional
public class Taex_mensajestiendaDaoImpl extends JdbcDaoSupport implements Taex_mensajestiendaDao {
    ...
    public Taex_mensajestiendaDaoImpl(DataSource dataSource2) {
